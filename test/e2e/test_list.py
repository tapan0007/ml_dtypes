...
def getBatchedJpgs(batchLevel):
    listExtraJpgs = [rnDogJpg, rnCatJpg, rnKoalaJpg, rnPandaJpg, fp16AccJpg] * ((batchLevel+5)//5)
...
# Multiple convolves
 ...
 ########### ########### ########### ########### ########### ########### ########### ###########
  ...
  "3-1conv1maxpool_k3d2_c1m1_wave"  : [ "trivnet_conv_pool_conv", "tfloat16-b1-h224-r3-s2-c1-m1-VALID-MaxPool-k3-d2-wmin-0.2-wmax0.3-imin-0.2-imax0.3", "1conv1pool", MEv2("Generic")],
  "3-1conv1maxpool_k3d2_h100r1s1c1m1_wave"  : [ "trivnet_conv_pool_conv", "tfloat16-b1-h100-r1-s1-c1-m1-VALID-MaxPool-k3-d2-wmin-0.2-wmax0.3-imin-0.2-imax0.3", "1conv1pool", MEv2("Generic")],
  ...
  "3-rn50-08_diag1_wave" : [ "trivnet_conv1",  "tfloat16-b1-h7-r3-s1-c512-m512-wmin2-wmax2-imin0-imax0",   "1conv", MEv2("Generic") + '--images diag1', '--input_files trivnet_input:0.npy'],
  "3-rn50-08_fp32_wave" : [ "trivnet_conv1",  "tfloat32-b1-h7-r3-s1-c512-m512-wmin-1-wmax1.1-imin-3-imax3.2",   "1conv", MEv2("Generic")],
  ...
  "3-rn50-16_wave_repl_largepsum" : [ "trivnet_conv1", "tfloat16-b1-h224-r7-s2-c3-m64-wmin-1-wmax1.1-imin-1-imax3", "1conv", MEv2("Generic-Repl-LargePSUM")],
  ...
  "7-rn50_nne_fp16_wave-no_repl"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --images %s " %(rnPreFp16, MEv2("RN50"), getBatchedJpgs(1)), "--diff_options '--tolerance 1.1 1e-5' --input_files %s" % getBatchedJpgs(1) ],
  #"7-rn50_nne_fp16_ap_wave-no_repl"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from_multi flatten_1/Shape,flatten_1/Reshape --executors wave 0 host 1  --scheduler wave2 --images %s" %(rnPreFp16, getBatchedJpgs(1)), "--input_files %s" % getBatchedJpgs(1) ],
  "7-rn50_nne_fp16_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --wavegraph_transform cleaner --images %s " %(rnPreFp16, MEv2("RN50-Repl-LargePSUM-NoVerify-TransposeOfmap"), getBatchedJpgs(1)), "--diff_options '--tolerance 1.1 1e-5' --input_files %s" % getBatchedJpgs(1) ],
  "7-rn50_nne_fp16_ap_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from_multi flatten_1/Shape,flatten_1/Reshape --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl"), getBatchedJpgs(1)), "--input_files %s" % getBatchedJpgs(1) ],

  "7-rn50_nne_fp16_wave-two_banks" : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-LargePSUM"), getBatchedJpgs(1)), "--env SIM_ADD_FLAGS=' --dram_frequency 6400' --diff_options '--tolerance 1.1 1e-5'  --input_files %s" % getBatchedJpgs(1) ],
  "7-rn50_nne_fp16_wave-fast_dram" : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-LargePSUM"), getBatchedJpgs(1)), "--env SIM_ADD_FLAGS=' --dram_frequency 0 --dram_latency 1' --diff_options '--tolerance 1.1 1e-5' --input_files %s" % getBatchedJpgs(1) ],
  ...
  "7-rn50_nne_fp16_b4_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 4 --wavegraph_transform cleaner --images %s "%(rnPreFp16, MEv2("RN50-Repl-LargePSUM-NoVerify-TransposeOfmap"), getBatchedJpgs(4)), "--input_files %s" % (getBatchedJpgs(4))],
  ...
  #"4-rn50_matmul_nosm_wave"   : [ "tf_pb",   "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", " --input_node input_1 --sg_input_format fc1000/Softmax NW --depth 2  --debug 1 %s  --partition from avg_pool/AvgPool fc1000/Softmax --executors host 0 2 wave 1 %s --images %s" %(rnPreFp16, MEv2("Generic"), rnDogJpg),"--input_files %s" % rnDogJpg ],
  "4-rn50_matmul_nosm_wave"   : [ "tf_pb",   "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", " --input_node input_1 --depth 2  --debug 1 %s  --partition from avg_pool/AvgPool fc1000/Softmax --executors host 0 2 wave 1 %s --images %s" %(rnPreFp16, MEv2("Generic-NoVerify-WaiveWC-TransposeOfmap"), rnDogJpg),"--input_files %s" % rnDogJpg ],
...
##################################################################
  ...
  ##########################################
  ## fp32,b32 on Tonga
  "4-ptb_word_small_sigmoid_fp32_wave"   : [ "tf_pb",   "ptb_word_lm/keras_unrolled/sigmoid/model-b32s4h512.pb","lm",
  ...
  "4-ptb_word_small_sigmoid_2l_fp32_wave"  : [ "tf_pb",   "ptb_word_lm/keras_unrolled/sigmoid/model-b32s4h512.pb","lm",
  (" --show_op_name_in_kgraph --input_node embedding_1_input_1  "
  + " --sg_input_format lstm_1_1/transpose HNC lstm_2_1/transpose HNC  --depth 3  --debug 1    "
  + " --partition from_multi  lstm_1_1/unstack,lstm_1_1/Tile_1,lstm_1_1/Tile,lstm_1_1/Tile_1  lstm_1_1/stack   lstm_2_1/unstack,lstm_2_1/Tile_1,lstm_2_1/Tile,lstm_2_1/Tile_1  lstm_2_1/stack      "
  + " --adjust_node_color  lstm_1_1/Tile 0 lstm_1_1/Tile_1 0 lstm_2_1/Tile 2 lstm_2_1/Tile_1 2    "
...
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 1 wave 0 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), " --diff_options '--tolerance 1.3 1e-5' --input_files %s" % rnDogJpg],
...
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat8" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_71/convolution,conv2d_73/convolution,max_pooling2d_4/MaxPool --executors host 1 wave 0 %s --input_node input_1 --images %s " %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), " --diff_options '--tolerance 1.0 1e-5' --input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s " %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), " --diff_options '--tolerance 1.0 1e-5' --input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat10" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s " %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), " --diff_options '--tolerance 1.0 1e-5' --input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --input_node input_1 %s --images %s --euler_options '--max_events 220'" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), " --diff_options '--tolerance 1.2 1e-5' --input_files %s" % rnDogJpg],
