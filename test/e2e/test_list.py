...
testConfigMap = {
  ...
  "0-1conv1avgpool_k3d1_wave"  : [ "trivnet_conv_pool", "tfloat16-b1-h4-r1-s1-c1-m1-SAME-AvgPool-k3-d1-wmin2-wmax2.2-imin1-imax16", "1conv1pool", "--scheduler wave2 --wavegraph_checks structure data-race"],
...
"9-inceptionv3_wave_dog_sg00_tpb" : ["tf_pb", "inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from mixed0/concat --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --save_layer_output' --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
...
#    ['9-inceptionv3_wave_dog', 'WAIVE_INCEPTIONV3'],
    ...
    ['0-1.*pool_wave_',      'WAIVE_INCEPTIONV3'],
