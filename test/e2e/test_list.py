...
# Multiple convolves
 ...
 ########### ########### ########### ########### ########### ########### ########### ###########
  ...
  "3-incep_ameoba_h299r3s2c3m32_wave_repl" : [ "trivnet_conv1", "tfloat16-b1-h299-r3-s2-c3-m32-VALID-wmin-1-wmax1.1-imin-3-imax3.2", "1conv",
...
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --input_node input_1 %s --images %s" %(incPreFp16, MEv2("Generic-CleanWG-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
  ...
  "7-amoebanet_fp16_cell1" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_1/cell_output/concat --partition from_multi cell_1/Relu,cell_1/Relu_1 --executors host all wave 1 --scheduler wave2 --schedule_options ' --nname=generic' --waive_wavegraph_checks --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (rnDogJpg), "--input_files %s" % (rnDogJpg)],
  ...
  "7-amoebanet_fp16_cell5" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_5/cell_output/concat --partition from_multi cell_5/Relu,cell_5/Relu_1 --executors host all wave 1 --scheduler wave2 --schedule_options ' --nname=generic' --waive_wavegraph_checks --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (rnDogJpg), "--input_files %s" % (rnDogJpg)],
