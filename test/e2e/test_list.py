...
# Multiple convolves
 ...
 ########### ########### ########### ########### ########### ########### ########### ###########
  ...
  "8-rn50_nne_fp16_b16_wave-no_repl"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 16 --images %s "%(rnPreFp16, MEv2("RN50-WaiveWC"), getBatchedJpgs(16)), "--input_files %s" % (getBatchedJpgs(16))],
  "8-rn50_nne_fp16_b16_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 16 --images %s "%(rnPreFp16, MEv2("RN50-Repl-WaiveWC"), getBatchedJpgs(16)), "--input_files %s" % (getBatchedJpgs(16))],
  "8-rn50_nne_fp16_b16_wave-two_banks"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 16 --images %s "%(rnPreFp16, MEv2("RN50-Repl-WaiveWC"), getBatchedJpgs(16)), "--env SIM_ADD_FLAGS=' --dram_frequency 6400' --input_files %s" % (getBatchedJpgs(16))],
  "8-rn50_nne_fp16_b16_wave-fast_dram"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 16 --images %s "%(rnPreFp16, MEv2("RN50-Repl-WaiveWC"), getBatchedJpgs(16)), "--env SIM_ADD_FLAGS=' --dram_frequency 0 --dram_latency 1' --input_files %s" % (getBatchedJpgs(16))],
  ...
  # Resnet50 bfloat16
  "7-rn50_nne_bfloat16_wave": [ "tf_s3", "s3://kaena-nn-models", "resnet50_bfp16infp16_keras_opt.pb", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 --wavegraph_transform 'cleaner,shell=perl -i -p -e s/float16/bfloat16/g wavegraph.json' --images %s " % (MEv2("RN50-no_verify"), rnBfloat16Npy), "--input_files %s --check_against_ref none" % rnBfloat16Npy ],
...
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat8" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_71/convolution,conv2d_73/convolution,max_pooling2d_4/MaxPool --executors host 1 wave 0 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat10" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --input_node input_1 %s --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
