...
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat8" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_71/convolution,conv2d_73/convolution,max_pooling2d_4/MaxPool --executors host 1 wave 0 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat10" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool --executors host 1 wave 0 --scheduler wave2 %s --input_node input_1 --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --input_node input_1 %s --images %s --wavegraph_transform euler" %(incPreFp16, MEv2("Generic-NoVerify-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
  ...
  "7-amoebanet_fp16_cell11" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_11/cell_output/concat --partition from_multi cell_11/Relu,cell_11/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s --wavegraph_transform euler --euler_options '--max_events 210'" % (MEv2("Generic-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
