...
# Multiple convolves
 ...
 ########### ########### ########### ########### ########### ########### ########### ###########
  ...
  "5-rn50_nne_to_act4_wave-no_repl"     : ["tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_4/Relu --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-CleanWG"), rnDogJpg),
  ...
  "5-rn50_nne_to_act4_wave-no_repl-all-layers" : ["tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_4/Relu --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-CleanWG-SaveAll"), rnDogJpg),
  ...
  "5-rn50_nne_to_act4_wave-repl" : ["tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_4/Relu --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG"), rnDogJpg),
    "--input_files %s" % rnDogJpg],
  ...
  "5-rn50_nne_to_act4_b4_wave"  : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", 
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_4/Relu --executors wave 0 host 1 %s --batch 4 --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG"), getBatchedJpgs(4)), 
  ...
  "5-rn50_nne_to_act13_wave-repl"     : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb", "resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_13/Relu --executors wave 0 host 1  %s --batch 1 --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],

  "5-rn50_nne_to_act13_wave-no_repl"  : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb", "resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_13/Relu --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-CleanWG-WaiveWC"), rnDogJpg),
    "--input_files %s" % rnDogJpg],

  "5-rn50_nne_to_act13_wave-no_repl-all-layers"     : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb", "resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_13/Relu --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-CleanWG-SaveAll-WaiveWC"), rnDogJpg),
    "--input_files %s  --check_against_ref all_available" % rnDogJpg],
  ...
  "6-rn50_nne_to_act46_wave-repl-order0"     : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--level_order_seed 0 --input_node input_1  --depth 2  --debug 1 %s --partition from activation_46/Relu --executors wave 0 host 1 %s --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],

  "6-rn50_nne_to_act46_wave-repl-order1"     : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--level_order_seed 1 --input_node input_1  --depth 2  --debug 1 %s --partition from activation_46/Relu --executors wave 0 host 1 %s --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],
  ...
  "7-rn50_nne_fp16_wave-no_repl"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --images %s " %(rnPreFp16, MEv2("RN50-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg ],
  ...
  "7-rn50_nne_fp16_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg ],
  "7-rn50_nne_fp16_ap_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from_multi flatten_1/Shape,flatten_1/Reshape --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg ],

  "7-rn50_nne_fp16_wave-two_banks" : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), rnDogJpg), "--env SIM_ADD_FLAGS=' --dram_frequency 6400'  --input_files %s" % rnDogJpg ],
  "7-rn50_nne_fp16_wave-fast_dram" : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), rnDogJpg), "--env SIM_ADD_FLAGS=' --dram_frequency 0 --dram_latency 1' --input_files %s" % rnDogJpg ],
  ...
  "7-rn50_nne_fp16_b4_wave-no_repl"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --batch 4 --images %s "%(rnPreFp16, MEv2("RN50-CleanWG-WaiveWC"), getBatchedJpgs(4)), "--input_files %s" % (getBatchedJpgs(4))],
  "7-rn50_nne_fp16_b4_wave"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1 %s --batch 4 --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(4)), "--input_files %s" % (getBatchedJpgs(4))],
  "7-rn50_nne_fp16_b4_wave-two_banks"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --batch 4 --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(4)), "--env SIM_ADD_FLAGS=' --dram_frequency 6400' --input_files %s" % (getBatchedJpgs(4))],
  "7-rn50_nne_fp16_b4_wave-fast_dram"        : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from fc1000/Softmax --executors wave 0 host 1  %s --batch 4 --images %s "%(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), getBatchedJpgs(4)), "--env SIM_ADD_FLAGS=' --dram_frequency 0 --dram_latency 1' --input_files %s" % (getBatchedJpgs(4))],
  ...
  "7-rn50_nne_fc_wave"          : [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", "--input_node input_1  --depth 2  --debug 1 %s --partition from avg_pool/AvgPool --executors wave 0 host 1 %s --images %s " %(rnPreFp16, MEv2("RN50-Repl-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg ],
  ...
  "4-rn50_matmul_nosm_wave"   : [ "tf_pb",   "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50", " --input_node input_1  --depth 2  --debug 1 %s  --partition from avg_pool/AvgPool fc1000/Softmax --executors host 0 2 wave 1 %s --images %s" %(rnPreFp16, MEv2("Generic-CleanWG"), rnDogJpg),"--input_files %s" % rnDogJpg ],
...
# act4 initial subgraphs
  ...
  "5-rn50_nne_to_act4_wave-no_repl-t9"     : ["tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--focus 'conv1/kernel|input_1|conv1/BiasAdd' --input_node input_1  --depth 2 --show_op_name_in_kgraph  --debug 1 --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16'  %s --images %s " %(MEv2("Generic-CleanWG"), rnDogJpg),
    "--input_files %s" % rnDogJpg],

  "5-rn50_nne_to_act4_wave-no_repl-t9_focus_to"     : ["tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--focus_to conv1/BiasAdd --input_node input_1  --depth 2 --show_op_name_in_kgraph  --debug 1 --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16' %s --images %s " %(MEv2("Generic-CleanWG"), rnDogJpg),
    "--input_files %s" % rnDogJpg],
...
##################################################################
  ...
  "4-ptb_word_small1_wave"   : [ "tf_pb",   "ptb_word_lm/keras_unrolled/model-b32s4h512.pb","lm",
    ...
    + " %s --images %s  "
    )% (MEv2("Generic-CleanWG-SaveAll-WaiveWC"), lstmD0T4), "--input_files %s" % lstmD0T4],
...
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat1" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_14/convolution,conv2d_16/convolution,conv2d_13/convolution,average_pooling2d_2/AvgPool --executors host 1 wave 0 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat2" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_20/convolution,conv2d_21/convolution,conv2d_23/convolution,average_pooling2d_3/AvgPool --executors host 1 wave 0 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 1 wave 0 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat1_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_14/convolution,conv2d_16/convolution,conv2d_13/convolution,average_pooling2d_2/AvgPool conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 0 2 wave 1 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat2_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_20/convolution,conv2d_21/convolution,conv2d_23/convolution,average_pooling2d_3/AvgPool conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 0 2 wave 1 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat3_concat4" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool conv2d_31/convolution,conv2d_32/convolution,conv2d_35/convolution,average_pooling2d_4/AvgPool --executors host 0 2 wave 1 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat4_concat5" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_31/convolution,conv2d_32/convolution,conv2d_35/convolution,average_pooling2d_4/AvgPool conv2d_41/convolution,conv2d_42/convolution,conv2d_45/convolution,average_pooling2d_5/AvgPool --executors host 0 2 wave 1 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat8_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_73/convolution,conv2d_71/convolution,max_pooling2d_4/MaxPool conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 0 2 wave 1 %s --input_node input_1 --images %s" %(incPreFp16, MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % rnDogJpg],
...
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --input_node input_1 %s --images %s" %(incPreFp16, MEv2("Generic-CleanWG-NoVerify"), rnDogJpg), "--input_files %s" % rnDogJpg],
  ...
  "7-amoebanet_fp16_pool" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_stem_1/AvgPool_1 --partition from cell_stem_1/Relu %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp32 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_evict" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --partition from_multi cell_stem_1/Relu,cell_stem_1/Relu_1,cell_0/Relu --executors wave 0 host 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp32 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell0" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_0/cell_output/concat --partition from_multi cell_0/Relu,cell_0/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell1" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_1/cell_output/concat --partition from_multi cell_1/Relu,cell_1/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell2" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_2/cell_output/concat --partition from_multi cell_2/Relu,cell_2/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell3" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_3/cell_output/concat --partition from_multi cell_3/Relu,cell_3/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell4" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_4/cell_output/concat --partition from_multi cell_4/Relu,cell_4/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell5" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_5/cell_output/concat --partition from_multi cell_5/Relu,cell_5/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell6" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_6/cell_output/concat --partition from_multi cell_6/Relu,cell_6/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell7" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_7/cell_output/concat --partition from_multi cell_7/Relu,cell_7/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell8" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_8/cell_output/concat --partition from_multi cell_8/Relu,cell_8/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell9" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_9/cell_output/concat --partition from_multi cell_9/Relu,cell_9/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell10" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_10/cell_output/concat --partition from_multi cell_10/Relu,cell_10/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_cell11" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to cell_11/cell_output/concat --partition from_multi cell_11/Relu,cell_11/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_rcell0" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to reduction_cell_0/cell_output/concat --partition from_multi reduction_cell_0/Relu,reduction_cell_0/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
  "7-amoebanet_fp16_rcell1" : [ "tf_s3", "s3://kaena-nn-models", "amoebanet_inference_graph_fp16.pb", "--input_node=transpose --focus_to reduction_cell_1/cell_output/concat --partition from_multi reduction_cell_1/Relu,reduction_cell_1/Relu_1 --executors host all wave 1 %s --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16 --size 299' --images %s" % (MEv2("Generic-CleanWG-WaiveWC"), rnDogJpg), "--input_files %s" % (rnDogJpg)],
}

def gen_rn50_nne_to_act_norepl(act_num, batch):
    return [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_%d/Relu --executors wave 0 host 1 %s --batch %d --images %s "%(rnPreFp16, act_num, MEv2("RN50-CleanWG-WaiveWC"), batch, getBatchedJpgs(batch)),
    "--input_files %s" % (getBatchedJpgs(batch))]

def gen_rn50_nne_to_act_repl(act_num, batch):
    return [ "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_%d/Relu --executors wave 0 host 1 %s --batch %d --images %s "%(rnPreFp16, act_num, MEv2("RN50-Repl-CleanWG-WaiveWC"), batch, getBatchedJpgs(batch)),
    "--input_files %s" % (getBatchedJpgs(batch))]
...
qemuTestWaiver = [
    ...
    ['4-ptb_word_small_sigmoid_wave$', 'WAIVE-QEMU-KAENA831'],
