...
# Multiple convolves
 ...
 ########### ########### ########### ########### ########### ########### ########### ###########
  ...
  "6-rn50_nne_to_act46_wave-no_repl"     : [
    "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_46/Relu --executors wave 0 host 1  --scheduler wave2 --images %s --schedule_options ' '  --waive_wavegraph_checks"%(rnPreFp16, getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],

  "6-rn50_nne_to_act49_wave-repl"     : [
    "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_49/Relu --executors wave 0 host 1  --scheduler wave2 --images %s --schedule_options ' --enable_replication '  --waive_wavegraph_checks"%(rnPreFp16, getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],

  "6-rn50_nne_to_act49_wave-no_repl"     : [
    "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--input_node input_1  --depth 2  --debug 1 %s --partition from activation_49/Relu --executors wave 0 host 1  --scheduler wave2 --images %s --schedule_options ' '  --waive_wavegraph_checks"%(rnPreFp16, getBatchedJpgs(1)),
    "--input_files %s" % (getBatchedJpgs(1))],
...
# act4 initial subgraphs
  ...
  "5-rn50_nne_to_act4_wave-no_repl-t1_focus_to"     : [
    ...
    + " --scheduler wave2 --schedule_options ' --nname=generic ' "
    + "--images %s --waive_wavegraph_checks "
    )%( rnDogJpg),
    "--input_files %s" % rnDogJpg
  ],
  ...
  "5-rn50_nne_to_act4_wave-no_repl-t9"     : [
    "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--focus 'conv1/kernel|input_1|conv1/BiasAdd' --input_node input_1  --depth 2 --show_op_name_in_kgraph  --debug 1 --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16'  --scheduler wave2 --schedule_options ' --nname=generic ' --images %s --waive_wavegraph_checks" %( rnDogJpg),
    "--input_files %s" % rnDogJpg
  ],

  "5-rn50_nne_to_act4_wave-no_repl-t9_focus_to"     : [
    "tf_pb", "resnet50_keras/resnet50_fp16_keras_opt2.pb","resnet50",
    "--focus_to conv1/BiasAdd --input_node input_1  --depth 2 --show_op_name_in_kgraph  --debug 1 --preprocessor $KAENA_PATH/compiler/util/res50_preprocessor.py  --preprocessor-args '--data-type fp16'  --scheduler wave2 --schedule_options ' --nname=generic ' --images %s --waive_wavegraph_checks" %( rnDogJpg),
    "--input_files %s" % rnDogJpg
  ],
...
##################################################################
  ...
  "4-ptb_word_small_sigmoid_2l_auto_waveopt"  : [ "tf_pb",   "ptb_word_lm/keras_unrolled/sigmoid/model-b32s4h512.pb","lm", " --show_op_name_in_kgraph --input_node embedding_1_input_1 --sg_input_format lstm_2_1/transpose_1 HNC  --depth 3  --debug 1   --partition levelauto   --executors  waveopt 0 2 4 --scheduler wave2 --schedule_options ' --nname=lm' --input_constants dropout_1/keras_learning_phase:0 False  --exclude_ops_from_capture ^dropout_1_1/cond/ --images %s --wavegraph_checks structure data-race" % lstmD0T4, "--input_files %s" % lstmD0T4],

   # LSTM debug of matmult, only sg00 is usable
  "2-ptb_word_unstack_matmul4"  : [ "tf_pb",   "ptb_word_lm/keras_unrolled/sigmoid/model-b32s4h512.pb","lm", " --show_op_name_in_kgraph --input_node embedding_1_input_1 --sg_input_format lstm_2_1/transpose_1 HNC  --depth 3  --debug 1   --partition from_multi  lstm_1_1/unstack,lstm_1_1/Tile_1,lstm_1_1/Tile,lstm_1_1/Tile_1   lstm_1_1/add_6,lstm_1_1/add_4,lstm_1_1/add_2,lstm_1_1/MatMul,lstm_1_1/MatMul_1,lstm_1_1/mul,lstm_1_1/mul_1  --adjust_node_color lstm_1_1/Tile 0 lstm_1_1/Tile_1 0  --executors wave 0 --scheduler wave2 --schedule_options ' --nname=lm' --input_constants dropout_1/keras_learning_phase:0 False  --exclude_ops_from_capture ^dropout_1_1/cond/ --images %s --wavegraph_checks structure data-race" % lstmD0T4, "--input_files %s" % lstmD0T4],
...
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat1" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_14/convolution,conv2d_16/convolution,conv2d_13/convolution,average_pooling2d_2/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat2" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_20/convolution,conv2d_21/convolution,conv2d_23/convolution,average_pooling2d_3/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies ' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_upto_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat1_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_14/convolution,conv2d_16/convolution,conv2d_13/convolution,average_pooling2d_2/AvgPool conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat2_concat3" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_20/convolution,conv2d_21/convolution,conv2d_23/convolution,average_pooling2d_3/AvgPool conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies ' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat3_concat4" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_28/convolution,conv2d_27/convolution,max_pooling2d_3/MaxPool conv2d_31/convolution,conv2d_32/convolution,conv2d_35/convolution,average_pooling2d_4/AvgPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat4_concat5" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_31/convolution,conv2d_32/convolution,conv2d_35/convolution,average_pooling2d_4/AvgPool conv2d_41/convolution,conv2d_42/convolution,conv2d_45/convolution,average_pooling2d_5/AvgPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies ' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat8_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_73/convolution,conv2d_71/convolution,max_pooling2d_4/MaxPool conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat9_concat10" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"5-inceptionv3_wave_dog_sg00_tpb_concat10_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool avg_pool/Mean --executors host 0 2 wave 1 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat4" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_31/convolution,conv2d_32/convolution,conv2d_35/convolution,average_pooling2d_4/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat5" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_41/convolution,conv2d_42/convolution,conv2d_45/convolution,average_pooling2d_5/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies ' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat8" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_71/convolution,conv2d_73/convolution,max_pooling2d_4/MaxPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"6-inceptionv3_wave_dog_sg00_tpb_upto_concat9" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_77/convolution,conv2d_78/convolution,conv2d_81/convolution,average_pooling2d_8/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat10" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from_multi conv2d_86/convolution,conv2d_87/convolution,conv2d_90/convolution,average_pooling2d_9/AvgPool --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic  --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
"7-inceptionv3_wave_dog_sg00_tpb_upto_concat11" : ["tf_pb", "inceptionv3/inceptionv3_fp16_keras_opt.pb", "inceptionv3", "%s --partition from avg_pool/Mean --executors host 1 wave 0 --scheduler wave2 --schedule_options '--nname=generic --relax_dependencies --no_verify' --waive_wavegraph_checks --input_node input_1 --images %s" %(incPreFp16, rnDogJpg), "--input_files %s" % rnDogJpg],
  ...
  "0-rtl-1avgpool_wave_h71c192m192k3d1"  : [ "trivnet_pool", "tfloat16-b1-h71-r1-s1-c192-m192-SAME-AvgPool-k3-d1-wmin-0.1-wmax0.2-imin-0.2-imax0.3", "1pool", "--scheduler wave2 --schedule_options ' --nname=generic ' --wavegraph_checks structure data-race"],
  "0-rtl-1avgpool_wave_h71c1m1k3d1_same"  : [ "trivnet_pool", "tfloat16-b1-h71-r1-s1-c1-m1-SAME-AvgPool-k3-d1-wmin-0.1-wmax0.2-imin-0.2-imax0.3", "1pool", "--scheduler wave2 --schedule_options ' --nname=generic ' --wavegraph_checks structure data-race"],
  "0-rtl-1avgpool_wave_h1c192m192k1d1_same"  : [ "trivnet_pool", "tfloat16-b1-h1-r1-s1-c192-m192-SAME-AvgPool-k1-d1-wmin-0.1-wmax0.2-imin-0.2-imax0.3", "1pool", "--scheduler wave2 --schedule_options ' --nname=generic ' --wavegraph_checks structure data-race"],
