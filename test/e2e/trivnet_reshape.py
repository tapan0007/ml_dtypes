...
output_shape    = [conf.B, conf.H*2, conf.H//2, conf.C]
...
i0b     = tf.reshape(i0, input_shape)
i1      = tf.nn.conv2d(i0b, w1, strides, "SAME", name = conf.netName + "/i1")
i2      = tf.reshape(i1, output_shape)
