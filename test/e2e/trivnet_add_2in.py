...
i0 = tf.placeholder(conf.tfDataType, shape=IF1.shape, name="input0")
i1 = tf.placeholder(conf.tfDataType, shape=IF1.shape, name="input1")
...
i1val  = conf.gen_array_rand(conf.IMIN, conf.IMAX, IF1.shape)

conf.gen_graph(output, input_data={'input0:0' : i0val, 'input1:0' : i1val})
