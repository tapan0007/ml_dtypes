                    ...
                    post {
                        always {
                            catchError {
                                ...
                                sh 'chmod -R a+wX /artifact/'
                                archiveArtifacts artifacts:'RunAllWithArgs/*.txt,*.tgz,RunAllWithArgs/**/*.txt,tgz,RunAllWithArgs/**/*.json, RunAllWithArgs/**/*.bin, RunAllWithArgs/**/*.svg, RunAllWithArgs/**/*.png, RunAllWithArgs/**/*.csv, RunAllWithArgs/**/*.asm, RunAllWithArgs/**/kelf.tar.gz'
