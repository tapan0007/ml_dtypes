...
class ConcatLayer(CombineLayer):
    #-----------------------------------------------------------------
    def __init__(self, (layerName, batch, ntwk), prev_layer, earlier_layer):
        ...
        super(ConcatLayer, self).__init__((layerName, batch, ntwk), prev_layer, earlier_layer, num_ofmaps)
