...
//****************************************************************
using DmaTriggerInstrBase = InstrTempl<::TONGA_ISA_TPB_PSEUDO_DMA_TRIGGER_INST,
                                       ::TONGA_ISA_TPB_OPCODE_PSEUDO_DMA_TRIGGER,
                                       ::tonga_isa_tpb_dma_trigger_check_validity>;


//****************************************************************
class DmaTriggerInstr : public DmaTriggerInstrBase {
private:
public:
    void SetDmaQueueName(const char* queName);
};
