...
#ifndef KCC_WAVE_TENSORSCALARWAVEOP_H
#define KCC_WAVE_TENSORSCALARWAVEOP_H
...
class TensorScalarWaveOp : public TensorWaveOp {
private:
    using BaseClass = TensorWaveOp;
public:
    class Params;
public:
    TensorScalarWaveOp(const TensorScalarWaveOp::Params& params,
                            const std::vector<WaveOp*>& prevWaveOps);
public:
    bool verify() const override;

private:
    TensorScalarWaveOp() = delete;

public:
    bool qTensorScalarWaveOp() const override {
        return true;
    }
...
}; // class TensorScalarWaveOp : public PoolEngWaveOp




class TensorScalarWaveOp::Params : public TensorWaveOp::Params {
public:
    bool verify() const;
public:
