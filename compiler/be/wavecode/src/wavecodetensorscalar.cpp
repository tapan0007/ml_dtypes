...
/**********************************************************************
**********************************************************************/
WaveCodeTensorScalar::WaveCodeTensorScalar(WaveCodeRef waveCode)
...
**********************************************************************/
void
WaveCodeTensorScalar::generate(wave::WaveOp* waveOp)
{
    auto tensorscalarWaveop = dynamic_cast<wave::TensorScalarWaveOp*>(waveOp);
    ...
    Assert(EngineId::Pooling == engineId, "Engine id for TensorScalar should be Pooling");
