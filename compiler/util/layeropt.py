        ...
        for i in op_list_iter:
            ...
            if (re.search(r"Relu|Tanh|Sigmoid|Exp|Identity|Lrelu|Prelu", layer_type)):
                ...
                for i in range(op_list.conv_op.Tn):
                    dram_resadd_waveops += tpb.statebuffer.circbuf_scratch.read_data_region(
                                                    wave_id, 
                ...
                for i in range(op_list.conv_op.Tn):
                    tpb.statebuffer.circbuf_scratch.free_data_region(self.conv_op.ofmap_tile_lower_addr[i], self.conv_op.ofmap_tile_upper_addr[i], tpb.waveop_stream.last_main_waveop)
                psum_bank_src = psum_bank_dst
