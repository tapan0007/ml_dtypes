...
##########################################################
class MacroActivLayer(MacroLayer, metaclass = ABCMeta):
    #-----------------------------------------------------------------
    ...
    #-----------------------------------------------------------------
    def generate(self):
        activFuncStr = self.gActivFunc()
        print("Generating " + activFuncStr + " compile instr")
        layer = self.gLayer()
        assert layer
        qq = '"'
        q = "'"
        ...
        s = ["// " + activFuncStr + ": " + layer.gName(),
             ...
             ind + inDataType + ",",
             ind + outDataType + ",",
             ind + "ACTIVATIONFUNC::" + activFuncStr + ");",
